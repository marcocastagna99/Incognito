...
def generate_data(num_tuples):
    ...
    for i in range(num_tuples):
        ...
        data.append([patient_id, data_datetime, age, height, gender,race, weight, zip_code, ]+ diseases)
...
# Now you can use args.num_tuples as the number of tuples
    ...
    with open(csv_filename, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        csvwriter.writerow(['patientId','dateandTime', 'age','height','gender', 'race', 'weight','zipCode', 'Hypertension', 'Arthritis', 'Asthma', 'Pneumonia', 'Diabetes'])
